...
cls & echo Great Bank ATM & PING localhost -n 1 >NUL & echo A script by Sameer Sabri and Ved Dhiman & PING localhost -n 3 >NUL & rem #intro message
cls & py -m pip install "%CD%/six-1.16.0-py2.py3-none-any.whl" "%CD%/keyboard-0.13.5-py3-none-any.whl"  & rem #This installs the module dependencies
